...
{
    /// <inheritdoc />
    public partial class Init_Project_Models : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExchangeMode = table.Column<int>(type: "int", nullable: false),
                    CreditCost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditCost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    RequesterNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ProviderNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_DomainUsers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sessions_DomainUsers_RequesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillTrades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SkillTrades_DomainUsers_OffererId",
                        column: x => x.OffererId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SkillTrades_DomainUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SkillTrades_Skills_OfferedSkillId",
                        column: x => x.OfferedSkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SkillTrades_Skills_RequestedSkillId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionId = table.Column<int>(type: "int", nullable: true),
                    SkillTradeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_DomainUsers_RevieweeId",
                        column: x => x.RevieweeId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_DomainUsers_ReviewerId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reviews_SkillTrades_SkillTradeId",
                        column: x => x.SkillTradeId,
                        principalTable: "SkillTrades",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillTrades_OfferedSkillId",
                table: "SkillTrades",
                column: "OfferedSkillId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillTrades_OffererId",
                table: "SkillTrades",
                column: "OffererId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillTrades_ReceiverId",
                table: "SkillTrades",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillTrades_RequestedSkillId",
                table: "SkillTrades",
